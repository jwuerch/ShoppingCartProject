...
export default Ember.Route.extend({
  ...
  model: function(params) {
    ...
    var bestbuyURL = 'https://api.bestbuy.com/v1/products(search=' + params.product + ')?format=json&show=sku,name,salePrice,thumbnailImage,image&apiKey=8wd6evarbuf826pkknt76e39';
